...
A2:
    ...
    Borg Cube - Star Trek First Contact
...
A5:
    ...
    HMS Endeavor, Micronauts

A6:

    HMS Endeavor, Micronauts
    Red Lectroid miniship and Black Lectroid mothership, The Adventures of Buckaroo Banzai Across the 8th Dimension
    Babylon 5
    Klingon D7 cruiser, Star Trek
...
A12:
    ...
    Crystal Bat, The Dark Crystal (1982)
...
B13:
    ...
    Ceti Alpha V Eel, Star Trek II The Wrath of Khan (1982)
...
F7: -Optimus Prime (Transformers) (also F8)
...
G1:
    ...
    "They Live We Sleep" tag, They Live (1988)
...
G5:
    ...
    Diva Pavalaguna, The Fifth Element (1997)
...
G8:
    ...
    Weebo (Flubber)
    Alien Vampires, Lifeforce

G9:

    Alien Vampires, Lifeforce
    Borg Queen Head Star Trek First Contact
    V Visitors sign with V graffiti, V

G10:

    Iron Giant Hand, The Iron Giant
    Flash Goron & Dale Arden on Hawkman Rocket Cycle, Flash Gordon (1980)
...
G12:
    ...
    StarChaser ship, StarChaser: The Legend of Orin (1985)
    Martian manta ship, War of the Worlds (1953)
...
H2:
    ...
    Robot Maria (Das Maschinenmensch), Metropolis (1927)
    Blue Sun poster, Firefly/Serenity (2002)
    Bai Ling as female Vulcan officer dancing, Sar Trek

H3:

    TARDIS (aka Sexy), Doctor Who
    Leeloo, The Fifth Element (1997)
    Lyn Me, Star Wars Return of the Jedi Special Edition
    Skeksis Chamberlain, The Dark Crystal
    Rystall, Star Wars Return of the Jedi Special Edition

H4:

    Rystall, Star Wars Return of the Jedi Special Edition (1997)
    Twiki - Buck Rogers
    VOC Robot, Doctor Who The Robots of Death
    Nalan Cheel (Modal Nodes Bith Band), Star Wars A New Hope (1977)
    Jabba the Hutt, Star Wars Return of the Jedi

H5:

    Jabba the Hutt, Star Wars Return of the Jedi (1983)
    Jeff Carlisle on Jabba's lap
    Tech Mo'r: Tech Mo'r: https://starwars.fandom.com/wiki/Tech_Mo'r
    Diva Pavalaguna, The Fifth Element (1997)
    Sy Snootles (in Jack Burton tank top), Return of the Jedi (1983)
...
H8:
    ...
    Future AI, AI: Artificial Intelligence (2001)
    B-9 Robot, Lost in Space (1965)
    Rambler Series Robot, Lost in Space (1998)
...
H9:
    ...
    Verda the Android, Lost in Space (1965)
    Jawa, Star Wars
    Body of Borg Queen, Star Trek First Contact
    Marvin, The Hitchhiker's Guide to the Galaxy (film)

H10:

    Lawgiver Statue, Planet of the Apes
    Cheetara and Lion-O, Thundercats
    Sith Statue, Star Wars Revenge of the Sith
    Yip Yip Alien, Sesame Street
    Atreides Space Ship, DUNE
...
I3:
    ...
    Marta, Orion slave girl (Star Trek: TOS, "Whom Gods Destroy") [Also J3]
...
I10:
    ...
    Thermian bartender (Galaxy Quest)
...
J1:
    ...
    Micronauts, Repto (Mego Micronauts Series 4/5, http://micronauts.wikia.com/wiki/Repto)
...
J6:
    ...
    Horta (Star Trek: TOS, "The Devil in the Dark")
    Morn (Star Trek: Deep Space Nine)

J7:

    Squidhead / Quarren (Star Wars: Episode VI - Return of the Jedi)
    Killer Klown (Killer Klowns from Outer Space)
...
L8:
    ...
    Twi'lek dignitary with STARLOG magazine (Star Wars: Episode III - Revenge of the Sith)

L9:

    Jessica Atreides (Dune)
    Starfleet communicator (on the floor)
    Nichelle Nichols / Nyota Uhura (Star Trek: The Original Series)
...
L13:
    ...
    Ring of the Schwartz - Spaceballs
...
M2:
    ...
    "Obey and Conform" sign, They Live (1988)
...
N1:
    ...
    Thermian bartender (Galaxy Quest)
    Bucket of Popplers from Fishy Joe's (Futurama) (bucket visible in O1)

N2:

    Donald Kessler head and Natalie Lake / dog hybrid (Mars Attacks!)
...
N7:
    ...
    "prawn" Christopher Johnson & son - District 9
...
N12:
    ...
    Father (Kilowatt) "Fix-It", Batteries Not Included (1987)
...
O10:
    ...
    Maz Kanata with Luke Skywalker's lightsaber (Star Wars)

O11:

O12:

    Mother (Carmen) "Fix-It", Batteries Not Included (1987)
    Father (Kilowatt) "Fix-It", Batteries Not Included (1987)
...
P8:
    ...
    Captain Dathon, Star Trek The Next Generation episode "Darmok"

P9:

    Captain Dathon, Star Trek The Next Generation episode "Darmok"
    Jen, Kira and Fizgig, The Dark Crystal

P10:

    Jake (Zunar J-5/9 Doric 4-7) - The Cat from Outer Space
...
Q11:
    ...
    Acroyear, The Micronauts
    Bug, The Micronauts
    Wheems "Fix-It", Batteries Not Included (1987)

Q12:

    Wheems & Jetsam "Fix-It", Batteries Not Included (1987)
    Revealed Alien Man (seen through the special sunglasses), They Live (1988)

Q13:

    Princess Mari (Marionette), The Micronauts
    Jetsam "Fix-It", Batteries Not Included (1987)
...
Figrin D'an and the Modal Nodes: https://www.starwars.com/databank/figrin-d-an-and-the-modal-nodes
